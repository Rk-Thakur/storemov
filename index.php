...
<header class="text-gray-600 body-font">
  ...
  <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="index.php">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      ...
      <a class="mr-5 hover:text-gray-900" href=""><?php  echo $_SESSION['uname'] ?></a>
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                  <h1 class="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">Store and Rewatch Your Video</h1> <a href="insertvideo.php"> <i class="fas fa-plus"></i> ADD VIDEO</a>
                </div>
            </div>
            <!-- video  -->
          ...
          <?php
    include('config.php');
    $query="SELECT * FROM video WHERE bywhom ='{$_SESSION['uname']}' ORDER BY id desc ";
